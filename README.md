...
The project has reached Stage 8:
...
```text
core/                 Runtime, registry, recommendation, planning, graph, monitoring logic
...
tests/                Stage 2-8 automated tests
